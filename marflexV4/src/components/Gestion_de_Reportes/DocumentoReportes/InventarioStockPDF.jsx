  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* Título */}
        <Text style={styles.sectionTitle}>Inventario en Stock</Text>
        ...
        <View style={styles.table}>
          ...
          {data.map((item, i) => (
            <View style={styles.tableRow} key={i}>
              <Text style={styles.tableCell}>{item.ID_MateriaPrima}</Text>
              <Text style={styles.tableCell}>{item.Nombre_MateriaPrima}</Text>
              <Text style={styles.tableCell}>{item.Cantidad_Disponible}</Text>
