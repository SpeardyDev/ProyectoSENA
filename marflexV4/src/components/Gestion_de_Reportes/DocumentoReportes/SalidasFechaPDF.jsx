    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.sectionTitle}>
          Salidas de Materias Primas por Fecha
        </Text>
        ...
        <View style={styles.table}>
          <View style={styles.tableRow}>
            ...
            <Text style={styles.tableTitulo}>Nombre M</Text>
          ...
          {data.map((item, i) => (
            <View style={styles.tableRow} key={i}>
              <Text style={styles.tableCell}>{item.ID_Movimiento}</Text>
...
SalidasFechaPDF.propTypes = {
  data: PropTypes.arrayOf(
    PropTypes.shape({
      ID_Movimiento: PropTypes.oneOfType([PropTypes.number, PropTypes.string]).isRequired,
...
export default SalidasFechaPDF;