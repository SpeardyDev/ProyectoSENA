...
const HomeAdmin = () => {
  const [visibleComponents, setVisibleComponents] = useState({dashboard: true,  categorias: false, productos: false, Proveedores: false });
        ...
        <FontAwesomeIcon className='menu-amburguesa'  icon={faBars} />
          ...
          <div className="sidebar">                                
              <ul>
                  ...
                  <li className="li-desplegable" onClick={() => handleButtonClick('categorias')}><a href={() => handleButtonClick('categorias')} className="item">Categorias</a></li>
                  <li className="li-desplegable" onClick={() => handleButtonClick('productos')}><a href={() => handleButtonClick('categorias')} className="item">Productos</a></li>
                  <li className="li-desplegable" onClick={() => handleButtonClick('Proveedores')}><a href={() => handleButtonClick('categorias')} className="item">Proveedores</a></li>
                  ...
                  <li className="li-desplegable"><a href="0" className="item">Usuarios</a></li>
